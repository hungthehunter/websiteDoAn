...
function Products_gtx_4080() {
  const [gtx_4080Off,gtx_4080On]=useState(false);

  const toggleGtx_4080= () => {
  ...
  return (
      ...
      <div className="inner">
        ...
        <span>Home Page           <span><BsSlashLg style={{marginLeft:0,marginRight:0}}></BsSlashLg></span>
                    ...
                    <span style={{color:"black"}}> ASUS PROART GeForce RTX 4080 16GB (PROART-RTX4080-16G)
                    </span></span>
          ...
          <div className="row">
            <div className="products-content">
              <div className="col l-4">
                <img src={PICTURE.GeForce_RTX4080} className="products-picture"></img>
              </div>
              <div className="col l-8">
                <div className="products-title-heading">
                <h2>ASUS PROART GeForce RTX 4080 16GB (PROART-RTX4080-16G)</h2>
                </div>
                <div className="products-price">
                  <span className="products-price-new">3.550.000₫</span>
                  <span className="products-price-old">5.990.000₫</span>
                  <span className="products-discount">-35%</span>
                </div>
...
export default Products_gtx_4080;
