  ...
  return (
      ...
      <div className="inner">
        ...
        <span>Home Page           <span><BsSlashLg style={{marginLeft:0,marginRight:0}}></BsSlashLg></span>
                    ...
                    <span style={{color:"black"}}> ASUS PROART GeForce RTX Titan 24GB (PROART-RTX4090-24G)
                    </span></span>
          ...
          <div className="row">
            <div className="products-content">
              <div className="col l-4">
                <img src={PICTURE.nvidia_titan_rtx} className="products-picture"></img>
              </div>
              <div className="col l-8">
                <div className="products-title-heading">
                <h2> GeForce RTX Titan 32GB (PROART-RTXTiTan-32G)</h2>
                </div>
                  ...
                  <div className="products-wrap">
                    <ul className="list-post">
                      <li className="item-post fade-box">
                        <div className="img-post">
                          <a
                            ...
                            href="https://gvn360.com/cong-nghe/galax-rtx-Titan-la-gpu-dau-tien-co-hdmi-retimer-de-truyen-du-lieu-duong-dai/"
                          >
                            <img
                              src={PICTURE.cardnew}
                              alt="Galax RTX Titan là GPU đầu tiên có HDMI Retimer để truyền dữ liệu đường dài"
                            ></img>
                          </a>
                        </div>
                        <div className="info-post">
                          <h3>
                          <a href="https://gvn360.com/cong-nghe/galax-rtx-Titan-la-gpu-dau-tien-co-hdmi-retimer-de-truyen-du-lieu-duong-dai/">Galax RTX Titan là GPU đầu tiên có HDMI Retimer để truyền dữ liệu đường dài</a>
                          </h3>
                        </div>
                      </li>
                      <li className="item-post fade-box">
                      ...
                      <li className="item-post fade-box">
                        ...
                        <div className="info-post">
                          <h3>
                          <a href="https://gearvn.com/blogs/cong-nghe/viet-nam-dat-muc-tieu-tro-thanh-quoc-gia-san-xuat-bong-ban-dan">Galax RTX Titan là GPU đầu tiên có HDMI Retimer để truyền dữ liệu đường dài</a>
                          </h3>
                        </div>
                      </li>
...
export default Products_gtx_Titan;
